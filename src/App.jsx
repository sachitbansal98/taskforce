...
const S = {
  ...
  fab: { position: "fixed", bottom: 24, right: 24", width: 58, height: 58, borderRadius: 18, background: "linear-gradient(135deg, #FF6B35, #F2994A)", color: "#fff", border: "none", cursor: "pointer", boxShadow: "0 4px 20px #FF6B3544, 0 0 0 4px #FF6B3512", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 },
